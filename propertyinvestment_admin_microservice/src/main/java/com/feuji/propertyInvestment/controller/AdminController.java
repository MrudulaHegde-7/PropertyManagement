...
public class AdminController {
	...
	public ResponseEntity<Admin> verifyAdminLogin(@PathVariable("adminName") String adminName,
			@PathVariable("password") String password) {
		Admin result = adminServiceImpl.verifyAdmin(adminName, password);
		return ResponseEntity.ok().body(result);
	}

	@GetMapping(value = "/admin/{adminName}/{password}")
	public ResponseEntity<Admin> getAdmin(@PathVariable("adminName") String adminName,
			@PathVariable("password") String password) {
